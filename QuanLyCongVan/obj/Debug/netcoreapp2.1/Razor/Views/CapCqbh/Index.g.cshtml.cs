#pragma checksum "E:\qlycongvan.git\trunk\QuanLyCongVan\Views\CapCqbh\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "674da5ff78d5e1df28428787bf3a86e2b9143808"
// <auto-generated/>
...
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"674da5ff78d5e1df28428787bf3a86e2b9143808", @"/Views/CapCqbh/Index.cshtml")]
...
#line hidden
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "b0aa0d68b9d94b21b318328a869cf861", async() => {
            }
            );
                    ...
                    <div class=""col-xs-12"">
                        <table class=""table table-responsive table-bordered"" id=""grid-table"">
                            ...
                            <tr ng-repeat=""sp in datagrid"">
                                <td>{{sp.maCapCQBH}} </td>
   ");
            WriteLiteral(@"                             <td>{{sp.tenCapCQBH}} </td>
                                <td> {{sp.ghiChu}}</td>
                                <td>
...
||||||| .r26
            ...
            <div class=""page-header"">
                <h1>
  ");
            WriteLiteral(@"                  Danh sách cấp cơ quan ban hành
                </h1>
            </div><!-- /.page-header -->
            <div class=""row"">
                <div class=""col-xs-12"">
                    <table class=""table table-responsive table-bordered"" id=""grid-table"">
                        ...
                        <tr ng-repeat=""sp in datagrid"">
                            ...
                            <td>
                                <a class=""btn btn-primary btn-sm"" ng-click=""onEdit(sp.id)""><i class=""fa fa-edit""></i></a>
                                <a class=""btn b");
            WriteLiteral(@"tn-danger btn-sm"" ng-click=""confirmdelete(sp.id)""> <i class=""fa fa-trash""></i></a>
                            </td>
                        </tr>
                    </table>
                    <div>
                ...
                <div class=""col-xs-12"">
                    <table class=""table table-responsive table-bordered"" id=""grid-table"">
                        ...
                        <tr ng-repeat=""sp in datagrid"">
                            ...
                            <td> {{sp.ghiChu}}</td>
                            <td>
                                <a class=""btn btn-primary btn-sm"" ng-click=""onEdit(sp.id)""><i class=""fa");
        ...
        <div class=""modal-dialog modal-sm dv-modal"" style=""width:60%"">
            <div class=""modal-content modal-xoa"">
                <div class=""tab-content tab-content_xoa"">
                    ...
                    <div class=""modal-footer no-border"">
                        <a cl");
            WriteLiteral(@"ass=""btn btn-success btn-xs btn-ok"" ng-click=""onDelete(idremove)""><i class=""fa fa-check-square-o""></i> Đồng ý</a>
